...
const server = http.createServer((req, res) => {
    ...
    req.on('data', function(data){
        ...
        conn.query('INSERT INTO trash.comments (comments.userName, comments.comment) VALUES (?,?)', [obj.name, obj.message], function(error, results, fields){
...

    {
        ...
        var conn = con.getConnection();
        conn.query('SELECT * FROM trash.comments', function(error, results, fields){
            if(error) throw error;
